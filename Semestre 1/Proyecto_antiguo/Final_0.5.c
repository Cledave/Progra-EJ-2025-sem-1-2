...
int main(){                                                                                 //Se inicia el programa
    ...
    if (opcion == 1) {                                                    
        ...
        printf("Ingresa A: ");                                                              //Imprime para ingresar A
            valid = scanf("%f",&a);                                                         //Guarda A en a
            while (a == 0 || valid != 1) {                                                  //Bucle para validar que A sea un valor valido, la funcion valid funciona enviando un 1 si el valor puede ser countavilizado 
                printf("Valor Invalido\nreingrese A:\t");                                   //Si no es valido entra en bucle hasta que si lo sea.
                while (getchar() != '\n');                                                  //Descarta los caracteres hasta encontrar el salto de linea y evita un bucle infinito
                valid = scanf("%f",&a);                                                     //Reemplaza el valor en valid de nuevo para hacer otra comprabacion y decidir si entra o sale del bucle
            }
        printf("Ingresa B: ");
            valid = scanf("%f",&b);
            while (valid != 1){
...
printf("                   B         \n");
        ...
        printf("Lado A:   ");
        valid = scanf("%f",&lado_A);
            if (lado_A==0){
                cont_lado = cont_lado - 1;                                                 //Printea y pregunta por los lados, si es el lado es 0 resta uno del contador y
            } else if (lado_A<0){                                                          // verifica que no sea negativo, si es negativo pregunta de nuevo
                printf("Lado invalido, reingrese Lado A:\t\n");
                scanf("%f",&lado_A);
            } while (valid != 1){
                printf("Valor Invalido\nreingrese Lado A:\t");
                while (getchar() != '\n');
        ...
        printf("Lado B:   ");
        valid = scanf("%f",&lado_B);
            if (lado_B==0){
                cont_lado = cont_lado - 1;
            } else if (lado_B<0){
                printf("Lado invalido, reingrese Lado B:\t\n");
                scanf("%f",&lado_B);
            } while (valid != 1){
                printf("Valor Invalido\nreingrese Lado B:\t");
                while (getchar() != '\n');
        ...
        printf("Lado C:   ");
        valid = scanf("%f",&lado_C);
            if (lado_C==0){
                cont_lado = cont_lado - 1;
            } else if (lado_C<0){
                printf("Lado invalido, reingrese Lado C:\t\n");
                scanf("%f",&lado_C);
            } while (valid != 1){
                printf("Valor Invalido\nreingrese Lado C:\t");
                while (getchar() != '\n');
        ...
        valid = scanf("%f",&ang_Alpha);
            ...
            } else if (ang_Alpha<0){                                                                        //ademas va registrando cuantos existen con el contador
